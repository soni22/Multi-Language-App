...
public class Constants {
    ...
    public static final String DRIVER_ARRIVED="3";
    public static final String TRIP_STARTRED="4";
    public static final String TRIP_COMPLETED="5";
    public static final String PROVIDER_RATING="6";
